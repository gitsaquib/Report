...
public class GenerateXlsReport {
	...
	public static void main(String[] args) throws IOException {
		File file  = new File("D:\\SeetestXlsReport\\AutomationRegressionReport_cadevelop.1.6.0.199-cadevelop_04202015.xls");
		file.createNewFile();
		OutputStream out = new FileOutputStream(file);
		short columnIndex = 2;
    	short columnWidth = 10000;
    	File htmlsFolder = new File("D:\\Seetest Reports\\04-20\\");
